                      ...
                      items: {
                        properties: {
                          ...
                          message: {
                            type: "string",
                            example:
                              "Domain example.com is already in use by application 'My Application'",
                          },
                        },
                        type: "object",
                      },
                ...
                schema: {
                  properties: {
                    message: {
                      type: "string",
                      example:
                        "Backup configuration and all executions deleted.",
                    },
                  },
                  type: "object",
                },
                ...
                schema: {
                  properties: {
                    message: {
                      type: "string",
                      example:
                        "Deployment cannot be cancelled. Current status: finished",
                    },
                  },
                  type: "object",
                },
                ...
                schema: {
                  properties: {
                    message: {
                      type: "string",
                      example:
                        "You do not have permission to cancel this deployment.",
                    },
                  },
                  type: "object",
                },
                ...
                schema: {
                  properties: {
                    message: {
                      type: "string",
                      example:
                        "This GitHub app is being used by 5 application(s). Please delete all applications first.",
                    },
                  },
                  type: "object",
                },
